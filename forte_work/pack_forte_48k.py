#!/usr/bin/env python3
"""Re-encode 9 forte stems at 48k mono, rebuild DATA_Forte.js."""
import base64
import glob
import os
import re
...
MP3_DIR = os.path.join(OUT_DIR, "mp3_48k")
TARGET_SEC = 3610.0
BITRATE = "48k"
...
def encode_track(name, src_path):
    ...
    cmd = ["ffmpeg", "-y", "-i", src_path, "-af", chain, "-c:a", "libmp3lame", "-b:a", BITRATE, dst]
...
def main():
    ...
    # write piecemeal to avoid huge peak
